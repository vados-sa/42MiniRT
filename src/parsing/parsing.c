...
/*   Updated: 2024/12/16 12:10:43 by pbencze          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * calls the according function for each element
 * (L, A, C, sp, pl, cy) or exits on error.
 * Then each function will take
 * the according line as parameter,
 * split the line into arrays containing different types of information on
 * color, points, normals, dimensions and ratio,
 * check if those are correct (e.g. they are in the given range,
 * they only contain numbers,
 * information is not missing etc.).
 * If not, exit and print an error message,
 * if yes, tore them inside data->scene.
 */
